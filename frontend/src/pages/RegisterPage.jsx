...
export default function RegisterPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      showToast({ title: 'Account created!', message: 'Please sign in.', level: 'success' });
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <select
                ...
                className="w-full bg-surface-2 border border-border-soft rounded-lg px-3 py-2.5 text-sm text-text-base focus:outline-none focus:ring-2 focus:ring-brand/40 focus:border-brand/40 transition-colors"
              >
