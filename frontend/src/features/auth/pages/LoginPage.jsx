...
import { ADMIN_HOME, USER_HOME, WORKER_HOME } from '../../../store/AuthContext.jsx';
      ...
      <div className="animate-fade-in-up relative z-10 w-full max-w-sm">
        <div className="bg-surface-1 border border-border-soft rounded-2xl p-8 shadow-2xl">
          ...
          >
            {googleLoading ? (
              <>
                <svg aria-hidden="true" focusable="false" className="animate-spin w-4 h-4 text-gray-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
